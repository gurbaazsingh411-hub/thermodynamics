            ...
            <div className="max-w-7xl mx-auto space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {SUBJECTS.map((subject, index) => (
                        ...
                        >
                            <Card className={`h-full border border-white/20 overflow-hidden relative bg-white/5 backdrop-blur-2xl hover:bg-white/10 transition-all duration-500 shadow-[0_8px_32px_rgba(0,0,0,0.4)] hover:shadow-primary/30 group-hover:-translate-y-1 bg-gradient-to-br ${subject.color}`}>
